...
-(IBAction)btnStartTapped:(id)sender
{
    ...
    NSString *str=[[NSBundle mainBundle] pathForResource:@"Alizee" ofType:@"MP4"];
    NSURL *u=[[NSURL alloc] initFileURLWithPath:str];
    [delegate initAndPlayMovie:u andViewController:self];
}
