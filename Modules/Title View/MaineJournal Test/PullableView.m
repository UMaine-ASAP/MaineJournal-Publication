...
/**
 Original Author Fabio Rodella fabio@crocodella.com.br
 */
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        handleView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"drag_bg.png"]];
        handleView.userInteractionEnabled = YES;
        handleView.frame = CGRectMake(0, frame.size.height - 40, frame.size.width, 40);
